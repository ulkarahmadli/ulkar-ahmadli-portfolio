...
-- Step 1: Create CourseManual_3NF
CREATE TABLE CourseManual_3NF AS
SELECT DISTINCT
    cm.ISBN,
    cm.Title,
    cm.Edition,
...
-- Step 1: Create Course_3NF
CREATE TABLE Course_3NF AS
SELECT DISTINCT
    CRN,
    Course_Name
FROM Course;
...
-- Step 2: Create Books_3NF
CREATE TABLE Books_3NF AS
SELECT DISTINCT
    ISBN,
    CRN
FROM Books;
